...
from utilis import save_data_structure, plot_loss
...
class Agent:
	...
	def optimize(self, step):
		...
		for epoch in range(1, self.epochs+1):
			...
			save_data_structure('results/training_loss.json', epoch, loss_numpy)
			save_data_structure('results/validation_loss.json', epoch, loss_numpy_val)
